...
<button class="add" onclick="downloadFormattedAttendance()">
...
// Function to handle the download of the formatted attendance sheet

function downloadFormattedAttendance() {
    var courseSelect = document.getElementById("courseSelect");
    var unitSelect = document.getElementById("unitSelect");

    var selectedCourse = courseSelect.value || "<?php echo $courseCode; ?>";
    var selectedUnit = unitSelect.value || "<?php echo $unitCode; ?>";
    ...
    window.location.href =
        "export-attendance-sheet?course=" +
...
// Function to update the table based on selected course and unit
...
// can be removed if the above function is working properly
